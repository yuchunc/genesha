...
#
#     PHX_SERVER=true bin/ganesha start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ganesha, GaneshaWeb.Endpoint, server: true
end
  ...
  config :ganesha, GaneshaWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/ganesha_web/router\.ex$"E,
        ~r"lib/ganesha_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :ganesha, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
