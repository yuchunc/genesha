...
config :ganesha, GaneshaWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: GaneshaWeb.ErrorHTML, json: GaneshaWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Ganesha.PubSub,
  live_view: [signing_salt: "ur0e1cU3"]
...
config :ganesha, Ganesha.Mailer, adapter: Swoosh.Adapters.Local
